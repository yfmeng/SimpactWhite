...
%% init
    function [elements, msg] = eventTest_init(SDS, event)
        ...
        P.CD4baseline = ones(1,9)*P.CD4baseline;
        
        P.criteria = false(1, 9);
        P.criteria(1) = true;
    ...
    function [SDS, P0] = eventTest_fire(SDS, P0)
        ...
        if P0.now<SDS.ARV_treatment.ARV_program_start_time
            ...
            if P0.index<= SDS.number_of_males
                ...
                nonbreast = false;
                agemix = false;
                concurrent = P0.maleRelationCount(P0.male)>1;
                for relIdx = find(currentIdx & (SDS.relations.ID(:, SDS.index.male) == P0.male) &...
                    ...
                    agemix = agemix|abs(P0.ageDifference(P0.male,P0.female))>=10;                    
                end
            else
                ...
                breast = false;
                agemix = false;
                concurrent = P0.femaleRelationCount(P0.female)>1;
           ...
           startTime = SDS.ARV_treatment.ARV_program_start_time;
            ...
            coverage = [coverage, ones(1,8)*coverageSubpop];
            
            eligibility = [true true pregnant serodiscordant sexwork old nonbreast agemix concurrent];
